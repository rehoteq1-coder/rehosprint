...
(() => {
  ...
  // Sign in anonymously right away so the PIN lookup below (which happens
  // before the visitor has a real account) is allowed by Firebase's
  // "auth != null" read rules. Logging in or registering afterwards
  // simply replaces this anonymous session with the real account.
